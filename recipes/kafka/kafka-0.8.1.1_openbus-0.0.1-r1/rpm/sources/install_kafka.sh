...
INSTALLED_LIB_DIR=${INSTALLED_LIB_DIR:-/usr/lib/kafka/libs}
BIN_DIR=${BIN_DIR:-/usr/bin}
CONF_DIR=${CONF_DIR:-/etc/kafka/conf.dist}


echo ye ye manuel $INSTALLED_LIB_DIR
...
install -d -m 0755 $PREFIX/$INSTALLED_LIB_DIR
install    -m 0644 ${BUILD_DIR}/core/build/dependant-libs-2.9.2/* $PREFIX/$INSTALLED_LIB_DIR/
install    -m 0644 ${BUILD_DIR}/core/build/libs/* $PREFIX/$INSTALLED_LIB_DIR/
