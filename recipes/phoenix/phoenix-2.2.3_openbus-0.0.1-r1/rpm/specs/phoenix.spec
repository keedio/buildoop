...
%define phoenix_version 2.2.3
%define phoenix_base_version 2.2.3
%define phoenix_release openbus0.0.1_1
...
License: APL2
Source0: %{name}-%{phoenix_base_version}-incubating-src.tar.gz
...
%prep
%setup -n %{name}-%{phoenix_base_version}-incubating
