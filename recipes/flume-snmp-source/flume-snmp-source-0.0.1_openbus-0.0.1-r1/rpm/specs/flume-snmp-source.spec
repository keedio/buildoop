...
%define flume_snmp_source_release openbus0.0.1_1
...
Name: flume-snmp-source
Version: %{flume_snmp_source_base_version}
...
BuildArch: noarch
License: APL2
Source0: flume-snmp-source.git.tar.gz
Source1: rpm-build-stage
Source2: install_flume-snmp-source.sh
Requires: flume
