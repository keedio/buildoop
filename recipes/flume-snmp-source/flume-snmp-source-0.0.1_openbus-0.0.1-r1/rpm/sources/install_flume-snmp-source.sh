...
cp ${BUILD_DIR}/target/flume-ng-snmp-source-*.jar ${PREFIX}/${LIB_DIR}
cp ${BUILD_DIR}/target/snmp4j-*.jar ${PREFIX}/${LIB_DIR}

install -d -m 0755 ${PREFIX}/${FLUME_CONF}
cp ${RPM_SOURCE_DIR}/flume-snmp-source.conf.example ${PREFIX}/${FLUME_CONF}
