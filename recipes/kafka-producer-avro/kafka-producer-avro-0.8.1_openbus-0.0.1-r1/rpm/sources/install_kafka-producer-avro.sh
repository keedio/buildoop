...
LIB_DIR=${LIB_DIR:-/usr/lib/kafka/lib/kafka-producer-avro/}
BIN_DIR=/usr/lib/kafka/bin
...
cp ${BUILD_DIR}/kafka-producer-avro.sh ${PREFIX}/${BIN_DIR}

install -d -m 0755 ${PREFIX}/${CONF_DIR}
cp ${BUILD_DIR}/conf/* ${PREFIX}/${CONF_DIR}
